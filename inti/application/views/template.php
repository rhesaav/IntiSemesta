                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <p class="dropdown-item" href="javascript:void(0)"><i class="ti-user m-r-5 m-l-5"></i> 
                                    <?php 
                                    if ($this->session->userdata('login_admin') == TRUE) {
                                        echo $this->session->userdata('nama_admin');
                                    }elseif ($this->session->userdata('login_pelanggan') == TRUE) {
                                ...
                                <?php 
                                    if ($this->session->userdata('login_admin') == TRUE) {
                                        echo '<a class="dropdown-item" href="'.base_url("admin/logout").'"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>';
                                    }elseif ($this->session->userdata('login_pelanggan') == TRUE) {
                                        echo '<a class="dropdown-item" href="'.base_url("customer/logout").'"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>';
                                    }else{}
                                     ?>
                            </div>
                        </li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('level')?>" aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">Level</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('admin')?>" aria-expanded="false"><i class="mdi mdi-account-star-variant"></i><span class="hide-menu">Admin</span></a>
                        </li>
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('customer')?>" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">Customer</span></a>
                        </li>   
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('tarif')?>" aria-expanded="false"><i class="mdi mdi-cash-usd"></i><span class="hide-menu">Tarif</span></a>
                        </li>
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('penggunaan')?>" aria-expanded="false"><i class="mdi mdi-cash-multiple"></i><span class="hide-menu">Penggunaan</span></a>
                        </li>
                        <?php if ($this->session->userdata('login_pelanggan') == TRUE) { ?>
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('pembayaran')?>" aria-expanded="false"><i class="mdi mdi-cash-multiple"></i><span class="hide-menu">Pembayaran</span></a>
                        </li>
                        <?php } ?>
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('verifikasi_pembayaran')?>" aria-expanded="false"><i class="mdi mdi-cash-multiple"></i><span class="hide-menu">Verifikasi</span></a>
                        </li>
                        <li class="sidebar-item"> 
                        ...
                        <!-- <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('tarif')?>" aria-expanded="false"><i class="mdi mdi-cash-usd"></i><span class="hide-menu">Payment</span></a>
                        </li> -->
